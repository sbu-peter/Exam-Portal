        ...
        <form action="submissions.php" method="post">
          <table class="sub-table">
            <thead>
             ...
             <!--Display the total submissions data in the tabe-->
             <?php while ($subDataRow = mysqli_fetch_assoc($subData)) { ?>
             <tr>
               <td><?php echo $subDataRow['Module Code'];  ?></td>
               <td><?php echo $subDataRow['Exam Date']; ?></td>
               <td><?php echo $subDataRow['Number of Students']; ?></td>
               <td><?php echo $subDataRow['Total Submissions']; ?></td>
            </tr>
          <?php  } ?>
            </table>
          </form>
